...
$dbconn = pg_connect("host=localhost user=postgres password=conejitalinda777 dbname=nuclear port=5432") or die('Could not connect: ' . pg_last_error());
...
//Leemos large object
$logo_data = pg_lo_read($lo_handle, '500000') or die('pg_lo_read failed: ' . pg_last_error());
if ($logo_data === false)
      echo "";
